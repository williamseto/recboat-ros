...
DMA Technical Report: Supplement to Department of Defense World Geodetic System
1984 Technical Report. Part I and II. Washington, DC: Defense Mapping Agency
*/

void LLtoUTM(int ReferenceEllipsoid, const double Lat, const double Long, 
			 double &UTMNorthing, double &UTMEasting, UTM_ZONE_TYPE &UTMZone)
{
  ...
  UTMZone.number = ZoneNumber;
  UTMZone.letterDesignator = UTMLetterDesignator(Lat);
...
void UTMtoLL(int ReferenceEllipsoid, const double UTMNorthing, const double UTMEasting, 
	     UTM_ZONE_TYPE* UTMZone, double& Lat,  double& Long )
{
  ...
  //	if((*ZoneLetter - 'N') >= 0)
  ZoneNumber = UTMZone->number;
  if((UTMZone->letterDesignator - 'N') >= 0)
