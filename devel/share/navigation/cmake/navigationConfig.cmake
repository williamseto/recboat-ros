...
if("TRUE" STREQUAL "TRUE")
  set(navigation_SOURCE_PREFIX /home/bikramjothanzra/recboat-ros/src/navigation)
  set(navigation_DEVEL_PREFIX /home/bikramjothanzra/recboat-ros/devel)
  ...
  set(navigation_INSTALL_PREFIX /home/bikramjothanzra/recboat-ros/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jeff McMahill <jmcm@nrec.ri.cmu.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bikramjothanzra/recboat-ros/src/navigation/${idir}'.  Ask the maintainer 'Jeff McMahill <jmcm@nrec.ri.cmu.edu>' to fix it.")
    endif()
...
set(navigation_EXPORTED_TARGETS "navigation_generate_messages_cpp;navigation_generate_messages_eus;navigation_generate_messages_lisp;navigation_generate_messages_py")
